...
```
$ docker image tag store huajwang/store
$ docker push huajwang/store
$ docker image tag invoice huajwang/invoice
$ docker push huajwang/invoice
$ docker image tag notification huajwang/notification
$ docker push huajwang/notification
```
